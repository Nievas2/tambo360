...
const Register: React.FC = () => {
  ...
  // Corregido: Se eliminó la variable 'error' que no se utilizaba
        ...
        <Card className="w-full max-w-125 border-none shadow-2xl py-8 bg-white/95 backdrop-blur-md rounded-xl relative">
          <CardContent className="space-y-8">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              {step === 1 && (
                <div className="space-y-2">
                  <h1 className="text-4xl font-bold tracking-tight text-[#0B1001]">Crear cuenta</h1>
            ...
            {step === 1 ? (
              ...
              <section className="h-full min-h-[40vh] flex flex-col items-center justify-center gap-6">
            ...
            {step === 1 && (
              <div className="text-center pt-4 border-t border-[#F2F1EC]">
                <p className="text-sm text-[#626059]">¿Ya tienes una cuenta? <Link to="/login" className="font-bold text-[#0B1001] hover:underline">Inicia sesión</Link></p>
              </div>
            )}
          </CardContent>
        </Card>
